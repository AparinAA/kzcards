...
export const metadata = {
	...
	description:
		"Оформление международных карт онлайн. Минимальное взаимодействие с банками, максимальная скорость оформления. Дистанционное открытие виртуальной банковской карты и быстрая доставка физической банковской карты по всей России",
};
